...
## 🎯 Objective
Phase VI focuses on implementing the **core business logic** of the Moonlight Agency PL/SQL system.  
The goal is to transform the database into an automated environment capable of:

- Managing celebrity bookings
- Detecting scheduling conflicts
- Processing payments and updating booking status
- Recording automated notifications
- Supporting revenue analytics
- Providing cursor-based reporting tools
- Organizing logic into professional PL/SQL packages

This phase ensures the system behaves dynamically and intelligently, just like a real booking and management platform.
...
### 🔁 DML Operations
DML operations were performed on:

- **CELEBRITY** (updates)
- **BOOKING** (inserts & updates)
- **PAYMENT** (inserts)
- **NOTIFICATIONS** (insert logs)
- **BRAND** (updates/maintenance)

These operations ensured realistic testing of transactions and system behavior.


`./screenshots/Phase VI/DML.png`

---

### 🧩 DDL Operations
DDL statements were used to:

- Add new supplemental fields  
- Modify constraints for PL/SQL logic  
- Create sequences for automated ID generation  
- Support triggers and notifications  

These structural updates helped enable automation within the system.

 
`./screenshots/Phase VI/DDL.png`
...
A window function was applied to calculate total payments made per celebrity.

This provides valuable financial insights and helps identify top performers.


`./screenshots/Phase VI/analytics.png`
...
- Automatically inserts a notification message  
- Ensures accurate and reliable schedule management  

  
`./screenshots/Phase VI/procedure_create_booking.png`

---

## 🧵 Cursor Integration
A cursor was used to list all **upcoming bookings** for any given celebrity.  
The output includes:
...
This supports the scheduling department with real-time visibility.

📷 **Screenshot Placeholder:**  
`./screenshots/Phase VI/cursor_usage.png`

---

## 🧪 Testing
All PL/SQL units were tested using anonymous PL/SQL blocks.  
Testing validated:
...
📷 **Screenshot Placeholder:**  
`./screenshots/Phase VI/testing.png`

---

## ✅ Function: `get_celebrity_revenue`
This function calculates the **total revenue generated** by a celebrity from completed bookings.
...
`./screenshots/Phase VI/function_test.png`

---

## 🚨 Trigger: Booking Log Trigger
A trigger was implemented to:

- Automatically log new bookings  
- Insert corresponding messages into the NOTIFICATIONS table  
- Enhance system auditing and traceability  


`./screenshots/Phase VI/trigger_test.png`

---

# 📦 PL/SQL Package: `moonlight_pkg`

The PL/SQL package contains:

- **create_booking** procedure  
- **process_payment** procedure  
- **get_celebrity_revenue** function  
- **list_upcoming_bookings** cursor procedure  
...
`./screenshots/Phase VI/package_spec.png`

 
`./screenshots/Phase VI/package_body.png`

 
`./screenshots/Phase VI/package_test.png`

---

# 📊 Window Function Analytics

A window function was used to compute total earnings per celebrity, allowing management to:

- Track revenue trends  
- Compare celebrity performance  
- Support strategic decision-making  

`./screenshots/Phase VI/window_function.png`

---

 

This phase establishes Moonlight Agency as a **dynamic, intelligent, and automated** management system.
